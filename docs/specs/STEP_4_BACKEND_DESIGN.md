...
- [ ] Run the production-adapter Playwright E2E journey against a configured Payload/PostgreSQL environment, covering save/resume, submit, clarification/report, notification, and lead CTA on mobile and desktop.
